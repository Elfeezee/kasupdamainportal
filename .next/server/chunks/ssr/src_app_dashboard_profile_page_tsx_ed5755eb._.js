...
function ProfilePage() {
    ...
    const fetchProfileData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (currentUser)=>{
        let profile = {
        ...
        try {
            ...
            const { data: userProfile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('din, name, phone').eq('uid', currentUser.id).maybeSingle();
            if (profileError) {
            ...
            const { data: latestAppData, error: appError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('applications').select('data').eq('user_id', currentUser.id).order('created_at', {
                ascending: false
            }).limit(1).maybeSingle();
            if (appError) {
...
//# sourceMappingURL=src_app_dashboard_profile_page_tsx_ed5755eb._.js.map