(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_dashboard_profile_page_tsx_503d0cb0._.js", {
...
function ProfilePage() {
    ...
    const fetchProfileData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProfilePage.useCallback[fetchProfileData]": async (currentUser)=>{
            let profile = {
            ...
            try {
                // Fetch supplemental data from the 'users' table
                const { data: userProfile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('din, name, phone').eq('uid', currentUser.id).maybeSingle();
                if (profileError) {
                    console.error("Error fetching from users table:", profileError.message);
                    toast({
                        title: "Error",
                        description: "Could not fetch DIN from profile.",
                        variant: "destructive"
                    });
                }
                if (userProfile) {
                ...
                // Fetch address info from the latest application
                const { data: latestAppData, error: appError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('applications').select('data').eq('user_id', currentUser.id).order('created_at', {
                    ascending: false
                }).limit(1).maybeSingle();
                if (appError) {
                    console.warn("Could not fetch address from applications:", appError.message);
                }
                if (latestAppData?.data) {
                    const appData = latestAppData.data;
                    const addressParts = [
                        appData.appHouseNo,
                        appData.appStreetName,
                        appData.appDistrict,
                        appData.appCityTown
                    ].filter(Boolean); // Filter out any undefined/null parts
                    if (addressParts.length > 0) {
                        profile.address = addressParts.join(', ');
                    }
                }
            } catch (error) {
                ...
                toast({
                    title: "Error",
                    description: "Failed to fetch some profile details.",
                    variant: "destructive"
                });
            } finally{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProfilePage.useEffect": ()=>{
            const initializeProfile = {
                "ProfilePage.useEffect.initializeProfile": async ()=>{
                    setLoading(true);
            ...
            }["ProfilePage.useEffect.initializeProfile"];
            initializeProfile();
        }
    }["ProfilePage.useEffect"], [
        router,
    ...
    const ProfileItem = ({ label, value, isLoading })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProfileItem, {
                                    label: "Developer Identification Number (DIN)",
                                    value: "",
                                    isLoading: true
                                }, void 0, false, {
                                    fileName: "[project]/src/app/dashboard/profile/page.tsx",
...
_s(ProfilePage, "LjUvaWeI2TL5Ef2Da04SyLr9PSQ=", false, function() {
    return [
...
//# sourceMappingURL=src_app_dashboard_profile_page_tsx_503d0cb0._.js.map