(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_06012530._.js", {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "DashboardPage.useEffect": async (event, session)=>{
                    const currentUser = session?.user || null;
                    setUser(currentUser);
                    if (currentUser) {
                        // Fetch user role from the public 'users' table in Supabase
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role').eq('uid', currentUser.id).single();
...
_s(DashboardPage, "Em0ZY7BwFKDOYRn+LtbW+tztzIQ=", false, function() {
    return [
...
//# sourceMappingURL=_06012530._.js.map