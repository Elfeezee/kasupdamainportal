(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_56545e44._.js", {
...
function MyApplicationsPageComponent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyApplicationsPageComponent.useEffect": ()=>{
            ...
            const loadedApps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$application$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApplications"])();
            // Filter applications for the "logged-in" user
            if (nameFromParams) {
                const userApps = loadedApps.filter({
                    "MyApplicationsPageComponent.useEffect.userApps": (app)=>app.applicantName === nameFromParams
                }["MyApplicationsPageComponent.useEffect.userApps"]);
                setApplications(userApps.sort({
                    "MyApplicationsPageComponent.useEffect": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
                }["MyApplicationsPageComponent.useEffect"]));
            } else {
                ...
                setApplications(loadedApps.sort({
                    "MyApplicationsPageComponent.useEffect": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
                }["MyApplicationsPageComponent.useEffect"]));
            }
            setLoading(false);
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            ...
                                            " ",
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(app.date), 'dd/MM/yyyy')
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/dashboard/my-applications/page.tsx",
                                        lineNumber: 125,
...
_s(MyApplicationsPageComponent, "Zg8UHZ/okxH4St46XVBR/UNEJvU=", false, function() {
    return [
...
//# sourceMappingURL=_56545e44._.js.map