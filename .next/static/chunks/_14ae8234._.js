(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_14ae8234._.js", {
...
function StageApprovalsPage() {
    ...
    const filteredApplications = applications.filter((app)=>{
        const termMatch = searchTerm.trim() === '' || app.applicant_name.toLowerCase().includes(searchTerm.toLowerCase()) || app.id.toLowerCase().includes(searchTerm.toLowerCase()) || (app.data?.originalPermitId || '').toLowerCase().includes(searchTerm.toLowerCase()) || (app.data?.din || '').toLowerCase().includes(searchTerm.toLowerCase());
...
//# sourceMappingURL=_14ae8234._.js.map