(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_5c4cdbe6._.js", {
...
function MyApplicationsPageComponent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyApplicationsPageComponent.useEffect": ()=>{
            const checkSession = {
                "MyApplicationsPageComponent.useEffect.checkSession": async ()=>{
            ...
            }["MyApplicationsPageComponent.useEffect.checkSession"];
            checkSession();
        }
    }["MyApplicationsPageComponent.useEffect"], [
        router
        ...
        "MyApplicationsPageComponent.useEffect": ()=>{
            ...
            const fetchApplications = {
                "MyApplicationsPageComponent.useEffect.fetchApplications": async ()=>{
                    setLoading(true);
                    try {
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('applications').select('*').eq('user_id', user.id).order('created_at', {
                            ascending: false
                        });
...
//# sourceMappingURL=_5c4cdbe6._.js.map