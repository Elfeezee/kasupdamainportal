(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_e8610875._.js", {
...
function StageApprovalsPage() {
    ...
    const filteredApplications = applications.filter((app)=>{
        const termMatch = searchTerm.trim() === '' || app.applicant_name.toLowerCase().includes(searchTerm.toLowerCase()) || app.id.toLowerCase().includes(searchTerm.toLowerCase()) || (app.data?.originalPermitId || '').toLowerCase().includes(searchTerm.toLowerCase());
...
//# sourceMappingURL=src_e8610875._.js.map