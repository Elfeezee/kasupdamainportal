(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_4016b5fd._.js", {
...
_s(AdminSidebar, "oB3WFZiy8mD07XyxihgKnJZzpzA=", false, function() {
    return [
        ...
        "AdminDashboardLayout.useEffect": ()=>{
            const checkAdminStatus = {
                "AdminDashboardLayout.useEffect.checkAdminStatus": async ()=>{
                    ...
                    // Session exists, now check the user's role from the public 'users' table
                    const { data: userProfile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role').eq('uid', session.user.id).single();
...
//# sourceMappingURL=src_4016b5fd._.js.map