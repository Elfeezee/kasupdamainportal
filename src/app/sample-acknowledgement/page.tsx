...
const sampleApplicationData: StoredApplication = {
  ...
  din: 'DIN123',
  app_house_no: '123',
  app_street_name: 'Main Street',
  app_district: 'GRA',
  app_city_town: 'Kaduna',
  app_state: 'Kaduna',
  plot_district: 'Unguwan Rimi',
  plot_lga: 'Kaduna North',
  plot_description_address: 'Plot 42, Block B, Unguwan Rimi GRA Extension',
  land_use: 'Residential Building',
