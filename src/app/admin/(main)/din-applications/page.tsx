...
import { MoreHorizontal, ListFilter, Search, Fingerprint, Trash2, Eye, Loader2, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function DinApplicationsPage() {
  ...
  return (
    <div className="space-y-8">
      <Card>
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle>DIN Applications</CardTitle>
              <CardDescription>Manage all submitted Development Identification Number applications.</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow><TableCell colSpan={6} className="h-24 text-center">No DIN applications found.</TableCell></TableRow>
                )}
              </TableBody>
            </Table>
          </div>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader><AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle><AlertDialogDescription>This action cannot be undone. This will permanently delete the DIN application for <span className="font-semibold">{applicationToDelete?.applicant_name}</span> (ID: {applicationToDelete?.din || applicationToDelete?.id}).</AlertDialogDescription></AlertDialogHeader>
