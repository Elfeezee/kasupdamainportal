...
import { MoreHorizontal, ListFilter, Search, ClipboardCheck, Trash2, Eye, Loader2, ChevronDown, ChevronUp } from 'lucide-react';
        ...
        <CardContent>
          <div className="flex items-center justify-between gap-4 mb-6">
            <div className="relative flex-1">
              ...
              <Input placeholder="Search by DIN, applicant, ID, or permit ID..." className="pl-10" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
            </div>
            <DropdownMenu>
            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow><TableCell colSpan={7} className="h-24 text-center">No stage approval applications found.</TableCell></TableRow>
                )}
              </TableBody>
            </Table>
          </div>
